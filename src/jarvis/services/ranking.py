...
class ResultRanker:
    ...
    def rank_results(self, results: List[Union[SearchResult, Dict[str, Any]]]) -> List[Union[SearchResult, Dict[str, Any]]]:
        """
    ...
    def deduplicate_results(self, results: List[Union[SearchResult, Dict[str, Any]]]) -> List[Union[SearchResult, Dict[str, Any]]]:
        """
