...
# Optional torch import for type annotations without hard dependency at import time
try:
    import torch  # type: ignore
    TorchTensor = torch.Tensor
except Exception:  # pragma: no cover - fallback for environments without torch
    from typing import Any as TorchTensor  # type: ignore
...
class ITaskQueue(ABC):
    ...
    @abstractmethod
    async def get_task_status(self, task_id: str) -> Any | None:
        """Get task status."""
        pass
