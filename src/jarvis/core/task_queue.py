...
class ITaskStore(ABC):
    ...
    @abstractmethod
    async def get_pending_tasks(self, limit: int | None = None) -> list[Task]:
        """Get pending tasks."""
        pass

    @abstractmethod
    async def get_failed_tasks(self, limit: int | None = None) -> list[Task]:
        """Get failed tasks."""
        pass
...
def task_function(name: str | None = None):
