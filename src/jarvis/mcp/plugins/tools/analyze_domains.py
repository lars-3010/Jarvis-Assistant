...
class AnalyzeDomainsPlugin(UtilityPlugin):
        ...
        return types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "include_bridges": {
                        "type": "boolean",
                        "description": "Include bridge opportunities in the analysis",
                        "default": True
                    },
                    "include_clusters": {
                        "type": "boolean",
                        "description": "Include semantic cluster details",
                        "default": True
                    },
                    "show_connections": {
                        "type": "boolean",
                        "description": "Show detailed cross-domain connections",
                        "default": True
                    },
                    "min_domain_size": {
                        "type": "integer",
                        "description": "Minimum number of notes required to form a domain",
                        "default": 3,
                        "minimum": 2
                    }
                },
    ...
    async def execute(self, arguments: Dict[str, Any]) -> List[types.TextContent]:
        ...
        try:
            ...
            return [types.TextContent(
                type="text",
                text=f"❌ Domain analysis failed: {str(e)}"
            )]
