...
from jarvis.extensions.interfaces import IExtension, ExtensionHealth, ExtensionStatus, MCPTool
    ...
    def list_extensions(self) -> Dict[str, Any]:
        ...
        for name in available:
            ...
            if name in loaded:
                ...
                if ext_info:
                    info["metadata"] = ext_info.metadata.dict()
                    info["health"] = ext_info.health_status.dict() if ext_info.health_status else None
