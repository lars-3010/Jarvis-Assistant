...
from .interfaces import TaskType, IModelRouter, ModelInfo
from .models import (
    ModelPerformanceMetrics, ModelRoutingConfig, TaskRoutingRule,
    LLMProviderConfig, LLMError
)
...
class ModelRouter(IModelRouter):
    ...
    def _get_candidate_models(
        self, 
        task_type: TaskType, 
        routing_rule: Optional[TaskRoutingRule]
    ) -> List[str]:
