...
class DatabaseErrorHandler:
    ...
    def handle_missing_database_error(self, context: dict[str, Any] | None = None) -> DatabaseInitializationError:
    ...
    def handle_corruption_error(self, original_error: Exception, backup_created: bool = False, backup_path: Path | None = None) -> DatabaseCorruptionError:
    ...
    def handle_disk_space_error(self, required_space: int | None = None) -> DiskSpaceError:
    ...
    def handle_connection_error(self, original_error: Exception, operation: str = "connect") -> DatabaseConnectionError:
        ...
        if "permission" in error_str:
            suggestions.extend([
                f"Check file permissions with: ls -la '{self.database_path}'",
